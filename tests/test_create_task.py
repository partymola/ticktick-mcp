...
class TestCreateTaskBuilderMissingFields:
    ...
    def test_dates_included_when_builder_omits_them(self, mock_client):
        ...
        mock_client.task.builder = MagicMock(return_value={
            "title": "Test task",
            "projectId": "proj123",
        })
        ...
        with patch(
            ...
            result = run(ticktick_create_task(
                title="Test task",
                projectId="proj123",
...
class TestCreateTaskNoExtraFields:
    ...
    def test_no_dates_no_extras_added(self, mock_client):
        ...
        with patch(
            ...
            result = run(ticktick_create_task(title="Simple task"))
    ...
    def test_none_priority_not_added(self, mock_client):
        ...
        with patch(
            ...
            result = run(ticktick_create_task(title="Task"))
