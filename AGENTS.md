...
The checks that need no client live in `_build_property_filter`, the one that needs the account lives in `_confirmed_project`. What a maintainer could reasonably undo:
